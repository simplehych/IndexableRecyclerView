 ...
 */
public class HeaderDesAdapter extends IndexableHeaderAdapter<StringEntity> {
    private Activity mActivity;

    public HeaderDesAdapter(Activity activity, String index, String indexTitle, List<StringEntity> datas) {
    ...
    public int getItemViewType() {
        return IndexType.TYPE_HEADER_DES;
    }
